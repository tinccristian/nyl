...
Texture EntityManager::LoadTexture(const char* file, bool alpha, std::string name)
{
    Textures[name] = loadTextureFromFile(file, alpha);
    return Textures[name];
}

Texture EntityManager::GetTexture(std::string name)
{
    return Textures[name];
}
...
Shader EntityManager::loadShaderFromFile(const char* vShaderFile, const char* fShaderFile, const char* gShaderFile)
{
...
Texture EntityManager::loadTextureFromFile(const char* file, bool alpha)
{
